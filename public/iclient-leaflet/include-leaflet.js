...
(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'leaflet')) {
            inputCSS('../../web/libs/leaflet/1.7.1/leaflet.css');
            inputScript('../../web/libs/leaflet/1.7.1/leaflet.js');
        }
        ...
        if (inArray(includes, 'd3')) {
            inputScript('../../web/libs/d3/7.0.3/d3.min.js');
        }
        ...
        if (inArray(includes, 'elasticsearch')) {
            inputScript('../../web/libs/elasticsearch/16.7.1/elasticsearch.min.js');
        }
        if (inArray(includes, 'deck')) {
            inputScript("../../web/libs/deck.gl/5.1.3/deck.gl.min.js");
        }
        if (inArray(includes, 'xlsx')) {
            inputScript('../../web/libs/xlsx/0.17.2/xlsx.core.min.js');
        }
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS("../../web/libs/plotting/leaflet/10.2.1/iclient-plot-leaflet.css");
            if (supportES6()) {
                inputScript("../../web/libs/plotting/leaflet/10.2.1/iclient-plot-leaflet-es6.min.js");
            } else {
                inputScript("../../web/libs/plotting/leaflet/10.2.1/iclient-plot-leaflet.min.js");
            }
        }
        ...
        if (inArray(includes, 'leaflet.markercluster')) {
            inputCSS("../../web/libs/leaflet/plugins/leaflet.markercluster/1.5.1/MarkerCluster.Default.css");
            inputCSS("../../web/libs/leaflet/plugins/leaflet.markercluster/1.5.1/MarkerCluster.css");
            inputScript("../../web/libs/leaflet/plugins/leaflet.markercluster/1.5.1/leaflet.markercluster.js");
        }
        ...
        if (inArray(includes, 'leaflet-geoman')) {
            inputCSS('../../web/libs/leaflet/plugins/leaflet-geoman/2.11.3/leaflet-geoman.css');
            inputScript('../../web/libs/leaflet/plugins/leaflet-geoman/2.11.3/leaflet-geoman.min.js');
        }
        ...
        if (inArray(includes, 'pixi')) {
          ...
          inputScript("../../web/libs/leaflet/plugins/Leaflet.PixiOverlay/1.8.2/L.PixiOverlay.min.js");
          inputScript("../../web/libs/leaflet/plugins/Leaflet.PixiOverlay/MarkerContainer.js");
        ...
        if (inArray(includes, 'leaflet-mapbox-gl')) {
            inputScript('../../web/libs/leaflet-mapbox-gl/0.0.15/leaflet-mapbox-gl.min.js');
        }
    }
